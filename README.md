...
- **✅ Verificación de Identidad**: Sistema robusto con Veriff, procesamiento inmediato de webhooks, almacenamiento de evidencia para auditorías y **soporte multi-credencial para integraciones externas**. [Ver detalles](docs/features/VERIFF-INTEGRATION.md).
