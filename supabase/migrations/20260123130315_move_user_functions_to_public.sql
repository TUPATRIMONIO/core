-- Migration: Move User Deletion Functions to Public Schema (Fixed)
-- Description: Moves the user deletion and dependency functions to public schema and fixes is_platform_admin reference
-- Created: 2026-01-23

-- 1. Eliminar funciones antiguas si existen
...
DROP FUNCTION IF EXISTS public.get_user_dependencies(UUID);
DROP FUNCTION IF EXISTS public.delete_user_with_cleanup(UUID, UUID, BOOLEAN);
