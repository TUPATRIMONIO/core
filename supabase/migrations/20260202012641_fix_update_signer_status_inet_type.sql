-- =====================================================
-- Migration: Fix update_signer_status_admin inet type
-- Description: Corrige el tipo de signature_ip de TEXT a INET
-- Created: 2026-02-02
-- =====================================================

-- Recrear la función con el tipo correcto para signature_ip
...
BEGIN
  ...
  EXCEPTION WHEN OTHERS THEN
    -- Si la IP no es válida, usar NULL
    v_ip := NULL;
  END;
...
BEGIN
  ...
  RAISE NOTICE '  - signature_ip ahora se convierte a INET correctamente';
END $$;
