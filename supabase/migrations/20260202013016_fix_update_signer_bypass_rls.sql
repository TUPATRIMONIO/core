-- =====================================================
-- Migration: Fix update_signer_status_admin to bypass RLS
-- Description: Agrega SET row_security = off para bypass de RLS
-- Created: 2026-02-02
-- =====================================================

-- Recrear la función con bypass de RLS explícito
...
DECLARE
  ...
  v_ip INET;
BEGIN
  -- Bypass RLS para esta operación
...
$$ LANGUAGE plpgsql 
   SECURITY DEFINER 
   SET search_path = signing, public, extensions;
...
DO $$
BEGIN
  RAISE NOTICE '✅ Función update_signer_status_admin con bypass RLS';
END $$;
