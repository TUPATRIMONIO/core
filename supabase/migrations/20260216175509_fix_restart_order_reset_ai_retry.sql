-- =====================================================
-- Migration: Fix restart_order to reset AI retry count
-- Description: Resetea ai_review_retry_count al reiniciar un pedido
--              para permitir nuevos intentos de revisión IA
-- Created: 2026-02-16
-- =====================================================

SET search_path TO billing, signing, core, public, extensions;

-- Reemplazar la función restart_order con la corrección
...
BEGIN
  ...
  SET 
    status = 'draft',
    signed_count = 0,
    ai_review_retry_count = 0, -- NUEVO: Resetear contador de reintentos
    qr_file_path = NULL,
  ...
  -- =====================================================
  -- Activar el flujo de firma automáticamente
...
DO $$
BEGIN
  RAISE NOTICE '✅ Función restart_order actualizada para resetear ai_review_retry_count';
END $$;
