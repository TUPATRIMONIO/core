 ...
 */
export function getOptimizedImageUrl(bucket, path, options = {}) {
    if (!SUPABASE_URL) {
        console.warn('NEXT_PUBLIC_SUPABASE_URL no está configurada');
        return '';
    }
 ...
 */
export function getBlogImageUrl(type, filename, size, quality = 80) {
 ...
 */
export function getBlogImageSrcSet(type, filename, sizes = ['small', 'medium', 'large'], quality = 80) {
    const srcSet = {};
    sizes.forEach((size) => {
 ...
 */
export function validateImageFile(file, type) {
 ...
 */
export function buildImagePath(type, slug, suffix, extension = 'webp') {
 ...
 */
export function getFeaturedImageUrl(slug, size, extension = 'webp') {
 ...
 */
export function getContentImageUrl(slug, index, size, extension = 'webp') {
 ...
 */
export function getCategoryIconUrl(categorySlug, extension = 'webp') {
 ...
 */
export function getAuthorAvatarUrl(authorSlug, size, extension = 'webp') {
 ...
 */
export function getMetaImageUrl(slug, extension = 'webp') {
