 ...
 * ```
 */
export function Icon({ icon: LucideIconComponent, size = 'md', variant = 'default', style = 'outline', className = '', }) {
    const classes = [
        sizeMap[size],
        variantMap[variant],
    ...
    return (_jsx(LucideIconComponent, { className: classes, strokeWidth: style === 'minimal' ? 1 : 1.5 }));
}
 ...
 * ```
 */
export function IconContainer({ icon: LucideIconComponent, variant = 'brand', shape = 'rounded', size = 'md', className = '', }) {
    ...
    return (_jsx("div", { className: containerClasses, children: _jsx(LucideIconComponent, { className: containerIconSizeMap[size], strokeWidth: 1.5 }) }));
}
