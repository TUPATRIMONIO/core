...
function UpdateNotification() {
    ...
    return (react_1.default.createElement(react_1.default.Fragment, null,
        ...
        react_1.default.createElement("div", { className: "fixed top-4 right-4 z-50 w-[420px] tp-animate-slide-in" },
            react_1.default.createElement(ui_1.Alert, { className: "!grid-cols-1 !gap-0 bg-[var(--tp-background-light)] border-[var(--tp-brand-20)] shadow-xl backdrop-blur-sm" },
                ...
                react_1.default.createElement("div", { className: "flex items-start gap-3 pt-2" },
                    ...
                    react_1.default.createElement("div", { className: "flex-1 space-y-2" },
                        react_1.default.createElement("div", { className: "flex items-start justify-between gap-2" },
                            react_1.default.createElement(ui_1.AlertTitle, { className: "!col-start-auto text-[var(--tp-background-dark)] font-quicksand text-base" }, "Nueva versi\u00F3n disponible"),
                        ...
                        react_1.default.createElement(ui_1.AlertDescription, { className: "!col-start-auto text-[var(--tp-lines)]" },
