...
import { createTransbankPaymentForCredits } from '@/lib/transbank/checkout';
...
export async function POST(request: NextRequest) {
  try {
    ...
    const result = await createTransbankPaymentForCredits(
      organizationId,
      packageId,
      returnUrl
    );
    ...
    console.error('Error creando checkout Transbank:', error);
    return NextResponse.json(
