      ...
      <div className="flex items-center justify-between">
        <div>
          ...
          <p className="text-muted-foreground mt-2">
            Organiza tus contactos en listas para campañas de marketing
          </p>
        </div>
        <Button asChild className="bg-[var(--tp-buttons)] hover:bg-[var(--tp-buttons-hover)]">
          <Link href="/dashboard/communications/lists/new">
              ...
              <CardContent>
                <div className="flex gap-2 pt-2">
                  <Button variant="outline" size="sm" asChild className="flex-1">
                    <Link href={`/dashboard/communications/lists/${list.id}`}>Gestionar</Link>
                  </Button>
                </div>
              </CardContent>
            </Card>
