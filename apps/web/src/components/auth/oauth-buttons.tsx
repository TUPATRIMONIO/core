...
type OAuthProvider = 'google' | 'facebook' | 'github' | 'apple'
  ...
  return (
    <div className="grid grid-cols-2 gap-3 sm:grid-cols-3">
      ...
      <Button
        ...
        className="relative flex items-center justify-center gap-2 border-[var(--tp-lines-30)] hover:border-[var(--tp-buttons)] hover:bg-[var(--tp-bg-light-10)] transition-all"
      >
        {loadingProvider === 'google' ? (
          <div className="h-4 w-4 border-2 border-[var(--tp-buttons)]/30 border-t-[var(--tp-buttons)] rounded-full animate-spin" />
        ) : (
