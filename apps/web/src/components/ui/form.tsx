...
> {
  name: TName
  control?: any // Relaxed type to avoid strict issues with ControllerProps
  render: (props: { field: any; fieldState: any; formState: any }) => React.ReactElement
}

// Custom FormField that handles the generic types properly for usage
const FormField = <
  TFieldValues extends FieldValues = FieldValues,
  TName extends FieldPath<TFieldValues> = FieldPath<TFieldValues>
>({
