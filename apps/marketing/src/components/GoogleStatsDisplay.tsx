...
export function GoogleStatsBadge() {
  ...
  if (loading) {
    return (
      <div className="flex items-center gap-2 px-4 py-2 bg-card rounded-full shadow-sm border border-[var(--tp-lines-20)] animate-pulse">
  ...
  return (
    <div className="flex items-center gap-2 px-4 py-2 bg-card rounded-full shadow-sm border border-[var(--tp-lines-20)]">
...
export function GoogleStatsMetrics() {
  ...
  if (loading) {
    return (
      <div className="animate-pulse">
        <div className="h-12 bg-muted rounded w-32 mb-2 mx-auto"></div>
        <div className="h-4 bg-muted rounded w-40 mb-1 mx-auto"></div>
  ...
  return (
    <div>
      ...
      <p className="text-foreground/90 font-medium">Calificación en Google</p>
      ...
      <div className="mb-8 flex flex-col items-center gap-4 animate-pulse">
        <div className="flex items-center gap-4">
          <div className="flex gap-1">
            {[1, 2, 3, 4, 5].map((i) => (
              <div key={i} className="w-7 h-7 bg-muted rounded"></div>
            ))}
          </div>
      ...
      <div className="flex items-center gap-4">
        <div className="flex items-center gap-2">
          ...
          <div className="flex flex-col">
            ...
            <span className="text-xs text-muted-foreground">de Google</span>
          </div>
        </div>
        ...
        <div className="text-center">
          ...
          <p className="text-xs text-muted-foreground">reseñas verificadas</p>
        </div>
      </div>

      {/* Badge de verificación de Google */}
      <div className="inline-flex items-center gap-2 px-4 py-2 bg-green-50 dark:bg-green-950 rounded-full border border-green-200 dark:border-green-800">
